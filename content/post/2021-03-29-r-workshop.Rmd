...
!["Place the project in a new directory"](img/new-directory.PNG)

!["We just need a regular project"](img/new-project-3.PNG)

!["Give your project a name, and tell RStudio where to put it"](img/new-directory.PNG)
...
!["Click the \"new script\" button in the upper left corner"](img/blank-project.PNG)
